...
public class RatingServiceImpl implements RatingService {
    ...
    public DriverDto rateDriver(Ride ride, Integer rating) {
        ...
        if(ratingObj.getDriverRating() != null) throw new RuntimeConflictException("Cannot rate more than one time.");
    ...
    public RiderDto rateRider(Ride ride, Integer rating) {
        ...
        if(ratingObj.getRiderRating() != null) throw new RuntimeConflictException("Cannot rate more than one time.");
